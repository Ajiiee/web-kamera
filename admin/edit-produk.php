...
<head>
    <title>Edit Produk - Tokopekita</title>
            ...
            <div class="main-content-inner">
                ...
                <div class="row justify-content-center mt-5 mb-5">
                  ...
                  <form method="post" action="" enctype='multipart/form-data'>
                    ...
                    <div class="form-group">
                      <label>Harga</label>
                      <input name="harga" type="number" value="<?= $produk['product_price'] ?>" class="form-control" required autofocus>
                    </div>
                    <div class="form-group">
                      <label>Deskripsi</label>
                      <input name="deskripsi" value="<?= $produk['product_description'] ?>" type="text" class="form-control" required autofocus>
                    </div>
                    <div class="form-group">
                      <label>Status</label>
